      ...
      <section className="space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
          {service.processSteps.map((step, index) => (
            <div key={step} className="rounded-2xl border border-brand-border bg-brand-card p-4 shadow-sm">
      ...
      <section className="space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {service.faqs.map((faq) => (
            <div key={faq.question} className="rounded-2xl border border-brand-border bg-brand-card p-5 shadow-sm sm:p-6">
